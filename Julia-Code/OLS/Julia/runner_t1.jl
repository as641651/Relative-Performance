...
function main()
    ...
    plotter = Benchmarker.Plot("julia_results_sample_Example01", ["algorithm"; "threads"]);
    Benchmarker.add_data(plotter, ["algorithm0"; 1], Benchmarker.measure(20, algorithm0, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["naive_julia"; 1], Benchmarker.measure(20, naive, matrices...) );
    Benchmarker.add_data(plotter, ["recommended_julia"; 1], Benchmarker.measure(20, recommended, matrices...) );
