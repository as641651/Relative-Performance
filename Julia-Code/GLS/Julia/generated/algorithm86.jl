...
function algorithm86(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y2: ml2, full, L21: ml1, lower_triangular, tmp33: ml4, full
    ml5 = Array{Float64}(undef, 500, 500)
    # tmp27 = (tmp33^T tmp33)
    syrk!('L', 'T', 1.0, ml4, 0.0, ml5)

    # y2: ml2, full, L21: ml1, lower_triangular, tmp33: ml4, full, tmp27: ml5, symmetric_lower_triangular
    # (L35 L35^T) = tmp27
    LinearAlgebra.LAPACK.potrf!('L', ml5)

    # y2: ml2, full, L21: ml1, lower_triangular, tmp33: ml4, full, L35: ml5, lower_triangular
    # tmp51 = (L21^-1 y2)
    trsv!('L', 'N', 'N', ml1, ml2)

    # tmp33: ml4, full, L35: ml5, lower_triangular, tmp51: ml2, full
