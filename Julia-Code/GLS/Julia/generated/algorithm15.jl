...
function algorithm15(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # tmp48: ml4, full, tmp39: ml5, full
    ml6 = Array{Float64}(undef, 500, 500)
    # tmp27 = (tmp48 tmp48^T)
    syrk!('L', 'N', 1.0, ml4, 0.0, ml6)

    # tmp39: ml5, full, tmp27: ml6, symmetric_lower_triangular
    # (L35 L35^T) = tmp27
    LinearAlgebra.LAPACK.potrf!('L', ml6)

    # tmp39: ml5, full, L35: ml6, lower_triangular
    # tmp41 = (L35^-1 tmp39)
    trsv!('L', 'N', 'N', ml6, ml5)

    # L35: ml6, lower_triangular, tmp41: ml5, full
    # tmp26 = (L35^-T tmp41)
    trsv!('L', 'T', 'N', ml6, ml5)
