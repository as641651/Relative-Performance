...
function algorithm87(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # X2: ml4, full, L21: ml1, lower_triangular, tmp33: ml3, full, tmp51: ml2, full
    # tmp33 = (L21^-1 X2)
    trsm!('L', 'L', 'N', 'N', 1.0, ml1, ml4)

    # tmp33: ml4, full, tmp51: ml2, full
    ml5 = Array{Float64}(undef, 500, 500)
    # tmp27 = (tmp33^T tmp33)
    syrk!('L', 'T', 1.0, ml4, 0.0, ml5)

    # tmp33: ml4, full, tmp51: ml2, full, tmp27: ml5, symmetric_lower_triangular
    # (L35 L35^T) = tmp27
    LinearAlgebra.LAPACK.potrf!('L', ml5)

    # tmp33: ml4, full, tmp51: ml2, full, L35: ml5, lower_triangular
