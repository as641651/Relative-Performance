...
function algorithm88(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # X2: ml4, full, L21: ml1, lower_triangular, tmp51: ml2, full, tmp33: ml3, full, tmp27: ml5, symmetric_lower_triangular
    # (L35 L35^T) = tmp27
    LinearAlgebra.LAPACK.potrf!('L', ml5)

    # X2: ml4, full, L21: ml1, lower_triangular, tmp51: ml2, full, tmp33: ml3, full, L35: ml5, lower_triangular
    # tmp33 = (L21^-1 X2)
    trsm!('L', 'L', 'N', 'N', 1.0, ml1, ml4)

    # tmp51: ml2, full, tmp33: ml4, full, L35: ml5, lower_triangular
