...
function algorithm56(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # tmp51: ml2, full, tmp48: ml3, full, tmp27: ml4, symmetric_lower_triangular
    # (L35 L35^T) = tmp27
    LinearAlgebra.LAPACK.potrf!('L', ml4)

    # tmp51: ml2, full, tmp48: ml3, full, L35: ml4, lower_triangular
    # tmp60 = (L35^-1 tmp48)
    trsm!('L', 'L', 'N', 'N', 1.0, ml4, ml3)

    # tmp51: ml2, full, L35: ml4, lower_triangular, tmp60: ml3, full
